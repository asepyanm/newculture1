        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a style="text-decoration:none" href="<?php echo Yii::app()->createUrl("sub/knowledge", array('id'=>$value['idsubkategori'])); ?>#knowing"><?php echo $value['namasub']; ?></a></li>
                            ...
                            ?>
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-7 col-md-7">
                                        <a style="text-decoration:none" href="<?php echo Yii::app()->createUrl("artikel/knowledge",array('id'=>$stoL->idcontent)); ?>">
                                            <?php echo $stoL->judul; ?>
                                        </a><br>
