<?php //var_dump(Yii::app()->createAbsoluteUrl(Yii::app()->request->getUrl()));exit;?>
<?php //var_dump(yii::app()->request->url);exit;?>
<script type="text/javascript">

    function PrintElem(elem)
    {
        var pr = document.getElementById('mydiv');
        //Popup(pr.innerHTML);
        window.print();
    }
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a style="text-decoration:none" href="<?php echo Yii::app()->createUrl("site/index"); ?>#<?php echo $value['idkategori']; ?>"><?php echo $value['namakat']; ?></a></li>
                    <li><a style="text-decoration:none" href="<?php echo Yii::app()->createUrl("sub/subactivation", array('id'=>$value['idsubkategori'])); ?>#<?php echo $value['idsubkategori']; ?>"><?php echo $value['namasub']; ?></a></li>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <?php 
                            ...
                            if(isset($img)){
                               echo "<img class='img-wrap-rev-no' src=\"data:image/jpeg;charset=utf-8;base64,".$img."\" >";
                            }
                        ?>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-7 col-md-7">
                                    <a style="text-decoration:none" href="<?php echo Yii::app()->createUrl("artikel/subactivation",array('id'=>$stoL->idcontent)); ?>">
                                        <?php echo $stoL->judul; ?>
                                    </a><br>
