		...
		<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/elastislide.css" />
		<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->theme->baseUrl; ?>/css/reset2.css" />			
		<noscript>
			<style>
				.es-carousel ul{
					display:block;
	...
	<section id="gallery" style="background:#1F1F1F url(<?php echo Yii::app()->theme->baseUrl; ?>/img/pattern.png) repeat top left;color:#fff;">
		<div class="container">
			<div class="row">
						...
						<div class="es-carousel-wrapper">
							...
							<div class="es-carousel">
								<ul>
				                    ...
				                    ?>
				                    		<!-- <li><a href="#"><div style="background:url(<?php echo Yii::app()->createUrl('/Content/displayImage', array('id'=>$value['idcontent'])); ?>) no-repeat top center / cover;width:65px;height:65px;" data-large="<?php // echo Yii::app()->createUrl('/Content/displayImage', array('id'=>$value['idcontent'])); ?>" alt="" data-description="<?php // echo $value['sinopsis']; ?>"></div></a></li> -->
											<li><a href="#"><img style="background:url(<?php echo Yii::app()->createUrl('/Content/displayImage', array('id'=>$value['idcontent'])); ?>) no-repeat top center / cover;width:65px;height:65px;" data-large="<?php echo Yii::app()->createUrl('/Content/displayImage', array('id'=>$value['idcontent'])); ?>" alt="" data-description="<?php echo $value['sinopsis']; ?>" /></a></li>
									<?php
											}
				                        }
				                    }
									...
									<li><a href="#"><img src="images/thumbs/9.jpg" data-large="images/9.jpg" alt="image09" data-description="Upon her head a platted hive of http://localhost/ResponsiveImageGallery/#straw" /></a></li>
