                ...
                <div class="panel-body">
                    <div class="box-body">
                        <div class="form-group">                    
                            ...
                            <div class="col-sm-10">
                                <?php echo Subkategori::model()->findByAttributes(array('idsubkategori'=>$model->idsubkategori))->nama; ?>                
                            </div>
                        </div>
                    ...
                    <?php if($boole->gambar==1){ ?>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                if($foto!="")
                                { ?>
                                    <img id="gambarKonten" src="<?php echo Yii::app()->createUrl('/Content/displayImage', array('id'=>$model->idcontent)); ?>" />
                                    ...
                                    <div class="input-group input-group-btn">
                                        <div class="form-control uneditable-input"><i class="icon-file fileupload-exists"></i>
                                            <span class="fileupload-preview">
                                                <?php echo CHtml::link($data->filename, array('Content/displayFile', 'id'=>$data->idlampiran), array('target'=>'_blank')); ?>
                    ...
                    <div class="box-footer">
                        ...
                        <input type="hidden" name="idsub" id="idsub" value="<?php echo $boole->idsubkategori; ?>">
                        
                        
                        <?php echo CHtml::htmlButton(Yii::t('mds','{icon} Simpan',array('{icon}'=>'<i class="fa fa-save"></i>')), array('style'=>'float:right;margin-left:5px;','class'=>'btn btn-success btn-lg', 'id'=>'simpan')); ?>            
...
<?php $this->endWidget(); ?>
<?php $this->renderPartial('_popkaryawan',array('user'=>$user));?>
...
<script type="text/javascript">
      $(document).ready(function(){
        ...
        if(isset($_GET['id'])){
            if($boole->label_judul=='NIK'){
                $kar = User::model()->findByattributes(array('N_NIK'=>$model->judul));
