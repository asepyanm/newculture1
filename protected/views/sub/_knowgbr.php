...
<div class="row">
	<div class="col-md-12">
        ...
        echo $isi; ?><a style="text-decoration:none" href="<?php echo Yii::app()->createUrl("Artikel/Knowledge",array('id'=>$value['idcontent'])); ?>"> Read More</a></p>
    </div>
</div>
<?php } ?>